module Enterprise::Internal::CheckNewVersionsJob
  ...
  def update_plan_info
    ...
    # Self-hosted installs manage their own plan/quantity locally and don't want the
    # daily hub sync (which always reports 'community' for unlicensed installs) to
    # overwrite that. Only sync these two fields for actual Chatwoot Cloud installs.
